...
View(new_numeric)
################################### HANDLING THE NON NUMERICAL COLUMN ###############################
...
#random forest
rf <- randomForest(Loan_No_Loan ~., data=new_train)
